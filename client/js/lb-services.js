  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Group.Servers.findById() instead.
        "prototype$__findById__Servers": {
          url: urlBase + "/Groups/:id/Servers/:fk",
          method: "GET",
        },

        // INTERNAL. Use Group.Servers.destroyById() instead.
        "prototype$__destroyById__Servers": {
          url: urlBase + "/Groups/:id/Servers/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Group.Servers.updateById() instead.
        ...
        // INTERNAL. Use Group.Servers.create() instead.
        "prototype$__create__Servers": {
          url: urlBase + "/Groups/:id/Servers",
          method: "POST",
        },

        // INTERNAL. Use Group.Servers.destroyAll() instead.
    ...
    /**
     * @ngdoc object
     * @name lbServices.Group.Servers
     * @object
     * @description
     *
     * The object `Group.Servers` groups methods
     * manipulating `Server` instances related to `Group`.
     *
     * Use {@link lbServices.Group#Servers} to query
     ...
     */
        ...
        R.Servers = function() {
          ...
          var action = TargetResource["::get::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#count
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
         * Counts Servers of Group.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.Servers.count = function() {
          var TargetResource = $injector.get("Server");
          var action = TargetResource["::count::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#create
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
        ...
        R.Servers.create = function() {
          var TargetResource = $injector.get("Server");
          var action = TargetResource["::create::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#destroyAll
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
        ...
        R.Servers.destroyAll = function() {
          var TargetResource = $injector.get("Server");
          var action = TargetResource["::delete::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#destroyById
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
        ...
        R.Servers.destroyById = function() {
          var TargetResource = $injector.get("Server");
          var action = TargetResource["::destroyById::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#findById
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
        ...
        R.Servers.findById = function() {
          var TargetResource = $injector.get("Server");
          var action = TargetResource["::findById::Group::Servers"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Group.Servers#updateById
         * @methodOf lbServices.Group.Servers
         *
         * @description
         *
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Group.Servers.findById() instead.
        "::findById::Group::Servers": {
          url: urlBase + "/Groups/:id/Servers/:fk",
          method: "GET",
        },

        // INTERNAL. Use Group.Servers.destroyById() instead.
        "::destroyById::Group::Servers": {
          url: urlBase + "/Groups/:id/Servers/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Group.Servers.updateById() instead.
        "::updateById::Group::Servers": {
          url: urlBase + "/Groups/:id/Servers/:fk",
          method: "PUT",
        },
